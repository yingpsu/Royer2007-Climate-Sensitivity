...
##
## (1) Y. Tang, P. Reed, T. Wagener, K. van Werkhoven, Comparing sensitivity analysis
##     methods to advance lumped watershed model identification and evaluation
##     Hydrology and Earth System Sciences, 11 (2) (2007), pp. 793-817
## (2) T.H. Andres, Sampling methods and sensitivity analysis for large parameter sets
##     Journal of Statistical Computation and Simulation, 57 (1–4) (1997), pp. 77-110
## (3) and Nossent et al (DOI: 10.1016/j.envsoft.2011.08.010)
##
...
save(list=c('x1','sens1','sens2','sens3','corr','T_test'), file='sobol_corr.RData')
